...
> SENG425 — Data Science, Ankara Yıldırım Beyazıt University
...
The `data/` and `figures/` directories are git-ignored — data is re-downloaded fresh and figures are regenerated by the notebook on demand.
...
- Internet access (datasets are streamed from GitHub mirrors at runtime)
